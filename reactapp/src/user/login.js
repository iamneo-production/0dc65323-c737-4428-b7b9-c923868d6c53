...
export default function login() {
    return (
        <div>
            ...
            <div className="form-group">
                <input type="password" className="passwords" placeholder="Enter Password" />
            </div>

          <NavLink to="/Dashboard">  <button type="submit" className="submitButtons">Submit</button></NavLink>
